...
document.getElementById("rzp-btn1").onclick = async function (e) {
  try {
    ...
    // const isAdmin=decodeToken.ispremiumuser // const isAdminUser=localStorage.getItem('isAdmin')
    // if(isAdmin){
    //   document.getElementById('rzp-btn1').style.visibility="hidden";
    ...
    console.log("169=====================================", response);
  console.log("ankit", response.razorpay_payment_id)
    var options = {
